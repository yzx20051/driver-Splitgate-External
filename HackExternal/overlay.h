...
void Draw3DBox(Vector3 TopBox, Vector3 BottomBox, ImColor color)
{
	auto Alpha_Top = Vector3(TopBox.x - 75, TopBox.y, TopBox.z + 25);
	auto Beta_Top = Vector3(TopBox.x, TopBox.y - 10, TopBox.z + 25);
	auto Gamma_Top = Vector3(TopBox.x + 75, TopBox.y, TopBox.z + 25);
	auto Delta_Top = Vector3(TopBox.x, TopBox.y + 10, TopBox.z + 25);

	auto Alpha_Bottom = Vector3(BottomBox.x - 75, BottomBox.y, BottomBox.z - 10);
	auto Beta_Bottom = Vector3(BottomBox.x, BottomBox.y - 10, BottomBox.z - 10);
	auto Gamma_Bottom = Vector3(BottomBox.x + 75, BottomBox.y, BottomBox.z - 10);
	auto Delta_Bottom = Vector3(BottomBox.x, BottomBox.y + 10, BottomBox.z - 10);

	DrawLine(ImVec2(Gamma_Top.x, Gamma_Top.y), ImVec2(Beta_Top.x, Beta_Top.y), color, 1);
	DrawLine(ImVec2(Gamma_Top.x, Gamma_Top.y), ImVec2(Delta_Top.x, Delta_Top.y), color, 1);
	DrawLine(ImVec2(Alpha_Top.x, Alpha_Top.y), ImVec2(Beta_Top.x, Beta_Top.y), color, 1);
	DrawLine(ImVec2(Alpha_Top.x, Alpha_Top.y), ImVec2(Delta_Top.x, Delta_Top.y), color, 1);
	DrawLine(ImVec2(Gamma_Bottom.x, Gamma_Bottom.y), ImVec2(Beta_Bottom.x, Beta_Bottom.y), color, 1);
	DrawLine(ImVec2(Gamma_Bottom.x, Gamma_Bottom.y), ImVec2(Delta_Bottom.x, Delta_Bottom.y), color, 1);
	DrawLine(ImVec2(Alpha_Bottom.x, Alpha_Bottom.y), ImVec2(Beta_Bottom.x, Beta_Bottom.y), color, 1);
	DrawLine(ImVec2(Alpha_Bottom.x, Alpha_Bottom.y), ImVec2(Delta_Bottom.x, Delta_Bottom.y), color, 1);
	DrawLine(ImVec2(Gamma_Top.x, Gamma_Top.y), ImVec2(Gamma_Bottom.x, Gamma_Bottom.y), color, 1);
	DrawLine(ImVec2(Alpha_Top.x, Alpha_Top.y), ImVec2(Alpha_Bottom.x, Alpha_Bottom.y), color, 1);
	DrawLine(ImVec2(Beta_Top.x, Beta_Top.y), ImVec2(Beta_Bottom.x, Beta_Bottom.y), color, 1);
	DrawLine(ImVec2(Delta_Top.x, Delta_Top.y), ImVec2(Delta_Bottom.x, Delta_Bottom.y), color, 1);
}
