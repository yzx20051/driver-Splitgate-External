...
inline namespace BloodHunt
{
	...
	{
	public:
		const char* dwProcessName = "PortalWars-Win64-Shipping.exe";
...
#define GameVars BloodHunt::Variables::Get()
	...
	public:
		...
		DWORD offset_u_world = 0x5b7dcd0;
		DWORD offset_g_names = 0x59fc0c0;
		...
		DWORD offset_health = 0x4ec;
		DWORD offset_max_health = 0x4f0;
